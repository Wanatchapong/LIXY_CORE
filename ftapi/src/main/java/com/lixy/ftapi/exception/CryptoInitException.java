...
public class CryptoInitException extends Exception{
	...
	public CryptoInitException(String description){
		super(description);
	...
	public CryptoInitException(String description, Throwable t){
		super(description, t);
		this.description = description;
		this.exceptionId = UUID.randomUUID().toString();
		this.t = t;
	...
	public CryptoInitException(String token, String description, Throwable t){
		super(description, t);
		this.description = description;
		this.exceptionId = UUID.randomUUID().toString();
		this.t = t;
